      ...
      >
        <div className="p-6 flex items-center gap-4 border-bottom border-white/5">
          ...
          {isSidebarOpen && (
            ...
            >
              SafeGuard <span className="text-sg-yellow">360</span>
            </motion.span>
          )}
        </div>
          ...
          {menuItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all ${
                activeTab === item.id 
                ? 'bg-sg-yellow text-black font-bold shadow-lg' 
        ...
        <div className="p-4 border-t border-white/5">
          <button 
            ...
            className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all text-sg-yellow`}
          >
            <Download size={22} />
        ...
        <header className="h-20 glass border-b border-white/5 flex items-center justify-between px-8 z-40">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="relative p-2 hover:bg-white/5 rounded-lg transition-colors">
              <Bell size={20} />
              <span className="absolute top-2 right-2 w-2 h-2 bg-sg-yellow rounded-full shadow-[0_0_10px_rgba(255,210,0,0.5)]"></span>
            </button>
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-sg-yellow to-yellow-600 flex items-center justify-center font-bold text-black">
              JD
            </div>
          </div>
        </header>
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <section className="relative overflow-hidden rounded-3xl glass p-12 border border-white/10">
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                <div className="space-y-6 max-w-xl">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-sg-yellow/10 border border-sg-yellow/20 rounded-full text-sg-yellow text-xs font-bold uppercase tracking-wider">
                    <Zap size={14} />
                    Premium Protection
                  </div>
                  <h1 className="text-5xl font-bold leading-tight">
                    Your Digital Life, <br />
                    <span className="text-sg-yellow">Completely Secured.</span>
                  </h1>
                  <p className="text-neutral-400 text-lg leading-relaxed">
                    Advanced multi-layered security for your devices, identity, and online privacy. 
                    SafeGuard 360 keeps you safe from evolving cyber threats.
                  </p>
                  <div className="flex flex-wrap gap-4">
                    <button 
                      onClick={startScan}
                      disabled={isScanning}
                      className="px-8 py-4 bg-sg-yellow text-black font-bold rounded-2xl hover:bg-yellow-400 transition-all flex items-center gap-3 shadow-xl shadow-sg-yellow/20 disabled:opacity-50"
                    >
                ...
                <div className="relative">
                  <motion.div 
                    ...
                    className="w-64 h-64 bg-sg-yellow/5 rounded-full flex items-center justify-center relative"
                  >
                    ...
                    <div className="w-48 h-48 bg-sg-yellow/10 rounded-full flex items-center justify-center">
                      <ShieldCheck className="text-sg-yellow" size={100} />
                    </div>
                  </motion.div>
                </div>
              </div>
              ...
              {isScanning && (
                <div className="absolute bottom-0 left-0 w-full h-1 bg-white/5">
                  <motion.div 
                    ...
                    className="h-full bg-sg-yellow shadow-[0_0_15px_rgba(255,210,0,0.8)]"
                  />
                </div>
              )}
            </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                <div className="glass rounded-3xl p-8 border border-white/5">
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <button className="text-sg-yellow text-sm font-bold hover:underline">Manage All</button>
                  </div>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-6 p-4 rounded-2xl hover:bg-white/5 transition-colors group cursor-pointer">
                        <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-sg-yellow group-hover:text-black transition-all">
              ...
              <div className="space-y-8">
                <div className="glass rounded-3xl p-8 border border-white/5 bg-gradient-to-br from-white/5 to-sg-yellow/5">
                  <h2 className="text-2xl font-bold mb-6">Subscription</h2>
                  <div className="p-6 rounded-2xl bg-sg-yellow/10 border border-sg-yellow/20 mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-sm font-bold text-sg-yellow">SafeGuard 360 Premium</span>
                      <Star className="text-sg-yellow" size={16} fill="currentColor" />
                    </div>
                    <p className="text-xs text-neutral-400 mb-4">Next billing date: Oct 24, 2026</p>
                    <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                      <div className="w-3/4 h-full bg-sg-yellow"></div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div key={i} className="flex gap-4">
                        <div className="w-1 h-10 bg-sg-yellow/20 rounded-full shrink-0"></div>
                        <div>
        ...
        {showInstallModal && (
          ...
          >
            <motion.div 
              ...
              className="bg-sg-dark border border-white/10 rounded-2xl p-8 max-w-md w-full shadow-2xl"
            >
              <div className="flex justify-between items-start mb-6">
                <div className="w-12 h-12 bg-sg-yellow/10 rounded-xl flex items-center justify-center">
                  <Download className="text-sg-yellow" size={24} />
                </div>
              ...
              <div className="space-y-6 mb-8">
                  ...
                  <div className="space-y-3 flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <a 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-sg-yellow text-black text-xs font-bold rounded-lg hover:bg-yellow-400 transition-all"
                      >
                ...
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-sg-yellow text-black flex items-center justify-center text-sm font-bold shrink-0">3</div>
